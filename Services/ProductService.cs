using   SURE_Store_API.Data;  // Import database context for data access
using SURE_Store_API.DTOs.Product;  // Import product data transfer objects
using SURE_Store_API.DTOs.Category;  // Import category data transfer objects
using SURE_Store_API.DTOs;  // Import main DTOs for responses and requests
